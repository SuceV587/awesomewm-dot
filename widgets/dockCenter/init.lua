...
local system_info          = require("widgets.dockCenter.system_info")
...
M_dock_center = {
  init              = function(screen)
    ...
    main_warp:setup { mianWdight, layout = wibox.container.margin, margins = utils.ui.dpiSize(30) }
  end,
  ...
  initMainWidget    = function(screen)
    ...
    -- local system_info_widget = system_info.init()
    -- rows_grid:add(system_info_widget)
